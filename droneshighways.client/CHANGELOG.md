...
- Create Angular project with ng: `ng new droneshighways.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`droneshighways.client.esproj`).
